...
CREATE TABLE `cart` (
  ...
  KEY `stock_id in cart` (`stock_id`),
  CONSTRAINT `stock_id in cart` FOREIGN KEY (`stock_id`) REFERENCES `stock` (`stock_id`),
...
CREATE TABLE `delivery_detail` (
  ...
  CONSTRAINT `order_id in delivery_detail` FOREIGN KEY (`order_id`) REFERENCES `order_book` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-03-25 23:57:31
